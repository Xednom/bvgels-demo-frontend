...
import FloatingConfigurator from '../../vue-bvgels/components/FloatingConfigurator.vue';
                ...
                <div class="w-full bg-surface-0 dark:bg-surface-900 py-20 px-8 sm:px-20" style="border-radius: 53px">
                    ...
                    <div>
                        <form @submit.prevent="onSubmit">
                            ...
                            <InputText id="username" type="text" class="w-full md:w-[30rem] mb-8" v-model="data.username" />

                            <label for="password1" class="block text-surface-900 dark:text-surface-0 font-medium text-xl mb-2">Password</label>
                            <Password id="password1" v-model="data.password" :toggleMask="true" class="mb-4" fluid :feedback="false"></Password>
